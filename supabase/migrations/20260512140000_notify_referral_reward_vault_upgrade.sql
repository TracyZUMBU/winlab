-- Upgrade pour les bases qui avaient déjà appliqué une version antérieure de
-- `20260511100000_profiles_push_token_referral_notify.sql` (littéraux / current_setting).
-- Idempotent : réapplique la définition Vault + trigger.
