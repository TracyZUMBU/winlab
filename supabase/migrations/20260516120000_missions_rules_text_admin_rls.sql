-- Mission règlement (Markdown FR) + RLS : admins peuvent lire/insérer/mettre à jour toutes les missions.
...
-- SELECT : les admins voient toutes les lignes (brouillons, etc.), en plus des politiques existantes (OR).
