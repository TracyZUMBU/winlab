-- Align "todo/home mission visibility" with submit_mission_completion rules:
-- - daily_login: at most one completion per UTC day
-- - other missions: max_completions_per_user NULL means unlimited repeats
