-- Enrich context_title when reference_id join misses (seed / legacy rows) by resolving
-- lottery via lottery_tickets.wallet_transaction_id and mission via mission_completions.reward_transaction_id.
