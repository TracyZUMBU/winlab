-- Repeatable missions fix:
-- - get_user_home_dashboard(): include missions until approved_count >= max_completions_per_user
-- - get_todo_missions_page(): include repeatable missions until approved_count >= max_completions_per_user

-- Canonical copy: supabase/schemas/functions/get_user_home_dashboard.sql
