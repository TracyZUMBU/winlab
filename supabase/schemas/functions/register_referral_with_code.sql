-- Optional parrainage at onboarding: referred user submits referrer's profile referral_code.
-- Idempotent skip when p_code is blank (trimmed). SECURITY DEFINER reads profiles.referral_code with elevated privileges.
