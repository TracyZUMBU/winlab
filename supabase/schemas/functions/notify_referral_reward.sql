-- Trigger : passage en `qualified` sur `referrals` → Edge Function Expo push via pg_net.
-- Secrets : Vault (`supabase_url`, `supabase_service_role_key`). Voir migration
-- `20260511100000_profiles_push_token_referral_notify.sql` et upgrade
-- `20260512140000_notify_referral_reward_vault_upgrade.sql`.
-- Script manuel : `sql_requetes/redeploy_notify_referral_reward.sql`.
