...
/** Compte valide mais email hors allowlist admin. */
    ...
    <div className="auth-login">
      <div className="auth-login__card">
        ...
        <p className="auth-login__subtitle">
          Le compte <strong>{user.email ?? "—"}</strong> n’est pas autorisé pour cet
          outil. Contactez un administrateur si vous pensez qu’il s’agit d’une erreur.
        </p>
        <button
