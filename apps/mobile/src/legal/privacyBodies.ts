...
L’Application est proposée aux utilisateurs résidant en France (métropole et départements d’outre-mer). L’utilisation depuis un autre pays peut être restreinte ; toute extension du périmètre fera l’objet d’une mise à jour de la présente politique.
...
• Données de profil : pseudonyme, photo de profil si vous en choisissez une, pays d’habitation (France), code de département d’habitation (métropole, Corse ou départements d’outre-mer), codes de parrainage le cas échéant.
...
The App is offered to users residing in France (including overseas departments). Use from other countries may be restricted; any expansion of this scope will be reflected in this policy.
...
• Profile data: username, profile photo if you choose one, country of residence (France), home department code (metropolitan departments, Corsica, or overseas departments), referral codes where applicable.
